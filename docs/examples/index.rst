...
.. toctree::
   :maxdepth: 2
   :caption: Creating Custom Components
...
1. :doc:`basics` - Learn the fundamental API and workflow
2. :doc:`custom_model` - Create your first custom continual learning algorithm
